...
// @See: https://github.com/StevenMHernandez/Android-ESP32-CSI/blob/master/src/main/java/com/stevenmhernandez/esp32csiserial/ESP32CSISerial.java

    public class ESP32CSISerial {

    private final Handler handler = new Handler();
    private CSIDataInterface listener;
    private DataCollector csiRecorderService = new CSIFileGenerator();
    ...
    private static class USBHandler extends Handler {
        ...
        public USBHandler(Activity activity, DataCollector dataService, String experimentName, CSIDataInterface listener) {
